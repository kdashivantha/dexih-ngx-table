...
The library can be imported into your project through npm.  

```bash
$ npm install dexih-ngx-table
```

This library also has a depdency (for drag/drop) on the ng2-dnd library.  This can be installed thorugh npm also:
